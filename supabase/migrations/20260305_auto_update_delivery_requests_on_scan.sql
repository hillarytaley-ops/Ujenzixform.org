-- ============================================================
-- Auto-Update delivery_requests Status on QR Scan
-- Created: March 5, 2026
-- 
-- When supplier dispatches (scans QR), update delivery_requests.status to 'in_transit'
-- When provider receives (scans QR), update delivery_requests.status to 'delivered'
-- This ensures deliveries automatically move between Scheduled/In Transit/Delivered tabs
-- ============================================================

-- Update the record_qr_scan function to also update delivery_requests
