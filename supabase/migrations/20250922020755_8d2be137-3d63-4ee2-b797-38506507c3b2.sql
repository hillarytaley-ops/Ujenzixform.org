-- ULTRA-STRICT SECURITY: Clean and protect driver_contact_data table
-- This prevents theft of driver contact information for harassment or identity theft

-- First, drop ALL existing policies on driver_contact_data
DO $$ 
DECLARE
...
BEGIN
    ...
    LOOP
        EXECUTE 'DROP POLICY IF EXISTS "' || policy_record.policyname || '" ON public.driver_contact_data';
    END LOOP;
END $$;
...
CREATE POLICY "driver_contact_data_admin_only_2024" 
...
-- Update the security definer function to be safer
