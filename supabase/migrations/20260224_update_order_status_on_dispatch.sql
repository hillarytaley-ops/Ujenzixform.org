-- ============================================================
-- Update Order Status to 'shipped' on Dispatch Scan
-- Created: February 24, 2026
-- 
-- Features:
-- 1. When a QR code is scanned for dispatch, update the purchase_order status to 'shipped'
-- 2. This provides better visibility in the supplier dashboard
-- ============================================================

-- ============================================================
-- Updated record_qr_scan function to also update order status
-- ============================================================
