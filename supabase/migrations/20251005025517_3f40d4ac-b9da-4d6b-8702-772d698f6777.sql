...
-- INSERT: Only during user creation
...
INSERT INTO public.security_events (
  ...
  jsonb_build_object(
    ...
    'security_model', 'Zero-trust: Users can only access their own data unless explicitly granted',
    'verification', 'All policies now explicitly deny unauthorized access'
  )
);