...
-- Only suppliers can manage their own data
...
INSERT INTO security_events (event_type, description, severity_level)
VALUES (
  'SUPPLIERS_TABLE_SECURED',
  'Applied strict RLS policies to suppliers table - access now restricted to business relationships only',
  'high'
);