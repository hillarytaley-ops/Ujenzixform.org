...
-- Fix search paths for the functions we created
DROP FUNCTION IF EXISTS detect_security_definer_views();
...
DROP FUNCTION IF EXISTS drop_security_definer_views();
...
DROP FUNCTION IF EXISTS check_for_security_definer_views();
...
DROP FUNCTION IF EXISTS prevent_security_definer_views();
