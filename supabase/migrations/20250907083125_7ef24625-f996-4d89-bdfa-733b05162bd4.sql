...
-- Issue: Supplier phone numbers and emails could be stolen by hackers
-- Solution: Implement strict business-relationship-based access control
-- ====================================================

-- Create audit table for supplier contact access
...
-- Only admins can view contact access audit logs
...
-- Create function to detect supplier contact harvesting patterns
...
-- Update the existing suppliers RLS policy to be more restrictive
DROP POLICY IF EXISTS "suppliers_working" ON suppliers;

-- Create new restrictive policy that logs access attempts
