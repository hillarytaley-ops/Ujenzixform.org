-- Fix function search paths to resolve remaining security linter warnings

-- Drop event trigger first to avoid dependency issues
...
INSERT INTO master_rls_security_audit (event_type, access_reason, additional_context)
VALUES (
    'SECURITY_DEFINER_VIEW_SEARCH_PATH_FIX_COMPLETE',
    'Function search paths fixed for all SECURITY DEFINER view prevention functions',
    jsonb_build_object(
