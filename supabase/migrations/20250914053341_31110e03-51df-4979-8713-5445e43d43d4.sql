...
-- 3. Enhanced function to detect and log suspicious access patterns
...
GRANT EXECUTE ON FUNCTION public.log_provider_access_and_detect_harvesting(uuid, text) TO authenticated;
...
INSERT INTO security_events (
  ...
  jsonb_build_object(
    'description', 'Enhanced protection for delivery provider personal information including contact masking, access monitoring, and secure availability checking',
    ...
    'addressed_vulnerabilities', ARRAY[
      'phone_number_exposure',
      'email_address_exposure', 
      'physical_address_exposure',
      'gps_location_stalking',
