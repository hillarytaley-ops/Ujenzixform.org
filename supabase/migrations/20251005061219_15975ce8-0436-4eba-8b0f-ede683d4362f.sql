...
INSERT INTO public.security_events (
  ...
  'high',
  jsonb_build_object(
    'description', 'Applied RLS policies and created secure views',
    'resources_protected', ARRAY[
      'delivery_notes - buyer/supplier access only',
      'profiles_business_directory - masked registration data',
      'projects_safe - masked location and access codes',
      'suppliers_public_directory - auth required'
    ],
    'timestamp', NOW()
  )
);