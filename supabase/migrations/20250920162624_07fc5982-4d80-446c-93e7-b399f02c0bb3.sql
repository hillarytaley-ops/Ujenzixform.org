-- CRITICAL SECURITY FIX: Driver Contact Information Protection (Corrected)
...
-- Create new restrictive policy - only admins get full access
...
-- Step 6: Log security improvement
INSERT INTO security_events (
    ...
    jsonb_build_object(
        ...
        'fixed_issues', ARRAY['Driver phone harvesting', 'Unauthorized driver contact access']
    )
);