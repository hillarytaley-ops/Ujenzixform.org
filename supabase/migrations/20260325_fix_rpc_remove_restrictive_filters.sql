-- ============================================================
-- FIX: Remove restrictive status filters from RPC function
-- This allows all 100 orders to appear consistently
-- ============================================================
...
BEGIN
  ...
  -- FIX: Removed restrictive 'rejected' and 'quote_rejected' filters
...
COMMENT ON FUNCTION public.get_deliveries_for_provider_unified() IS
  'Single source for Delivery Dashboard: scheduled + in_transit + delivered. Uses material_items scan counts (aligned with Supplier QR/Orders). FIXED: Removed restrictive rejected/quote_rejected filters to show all 100 orders.';
