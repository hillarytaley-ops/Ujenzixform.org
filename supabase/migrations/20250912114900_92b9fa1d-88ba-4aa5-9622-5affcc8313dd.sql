-- CORRECTED COMPREHENSIVE SECURITY FIX: Address all Aikido security vulnerabilities
...
-- 7. Create comprehensive audit logging for data modifications only
...
-- Add logging triggers for data modifications only (INSERT, UPDATE, DELETE)
...
DROP TRIGGER IF EXISTS log_suppliers_access ON public.suppliers;
CREATE TRIGGER log_suppliers_access
