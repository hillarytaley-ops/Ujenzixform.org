-- Fix suppliers directory security with proper severity value
-- 1. Remove the problematic view (suppliers_directory_public)
...
-- 3. Log security fix with proper severity value
