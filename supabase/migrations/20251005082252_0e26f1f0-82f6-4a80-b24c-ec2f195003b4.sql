...
DROP POLICY IF EXISTS "profiles_owner_insert_only" ON public.profiles;
...
DROP POLICY IF EXISTS "payments_owner_and_admin_read" ON public.payments;
DROP POLICY IF EXISTS "payments_owner_create" ON public.payments;
DROP POLICY IF EXISTS "payments_owner_and_admin_update" ON public.payments;
DROP POLICY IF EXISTS "payments_admin_delete_only" ON public.payments;
...
-- Drop ALL existing tracking policies
DROP POLICY IF EXISTS "tracking_admin_full_access" ON public.delivery_tracking;
DROP POLICY IF EXISTS "tracking_provider_update_own" ON public.delivery_tracking;
