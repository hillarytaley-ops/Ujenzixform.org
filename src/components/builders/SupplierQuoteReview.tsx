  ...
  const handleAcceptQuote = async (quote: QuotationRequest) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'QR codes are being generated. Please choose delivery or pickup option.',
      });

      console.log('📦 Quote accepted, status set to confirmed. QR codes should be auto-generated by database trigger.');
