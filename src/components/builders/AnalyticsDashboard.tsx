...
import { 
  ...
  DollarSign, Users, Star, Phone, Mail, MapPin, Clock
} from 'lucide-react';
  ...
  useEffect(() => {
    const mockAnalytics = {
      ...
      inquiryTypes: [
        ...
        { name: 'Renovation', value: 18, color: '#f59e0b' },
        { name: 'Industrial', value: 9, color: '#ef4444' }
      ],
      locationBreakdown: [
      ...
      monthlyRevenue: [
        { month: 'Jan', revenue: 2400000, projects: 3 },
        { month: 'Feb', revenue: 1800000, projects: 2 },
        { month: 'Mar', revenue: 3200000, projects: 4 },
        { month: 'Apr', revenue: 2800000, projects: 3 },
        { month: 'May', revenue: 4100000, projects: 5 },
        { month: 'Jun', revenue: 3600000, projects: 4 },
        { month: 'Jul', revenue: 2900000, projects: 3 },
        { month: 'Aug', revenue: 3800000, projects: 4 },
        { month: 'Sep', revenue: 4500000, projects: 5 }
      ],
      recentActivity: [
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="engagement" className="space-y-6">
        ...
        <TabsContent value="engagement" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Profile Views & Contacts</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={analytics.profileViews}>
                  ...
                  <Area type="monotone" dataKey="contacts" stackId="2" stroke="#10b981" fill="#10b981" fillOpacity={0.6} />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={250}>
                  <PieChart>
                    ...
                    >
                      {analytics.inquiryTypes.map((entry: any, index: number) => (
