...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-[10100] bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, compact, "aria-describedby": ariaDescribedBy, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    ...
    >
      ...
      <DialogPrimitive.Close className={cn(
        ...
        compact ? "right-1 top-1" : "right-4 top-4"
      )}>
