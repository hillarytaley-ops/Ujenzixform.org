...
export const DOCS_MONITORING_STREAMING_STEPS = `${REPO_DOC_BASE}/docs/MONITORING_STREAMING_IMPLEMENTATION_STEPS.md`;
export const DOCS_CAMERAS_HIKVISION = `${REPO_DOC_BASE}/docs/CAMERAS_HIKVISION_UJENZIXFORM.md`;
