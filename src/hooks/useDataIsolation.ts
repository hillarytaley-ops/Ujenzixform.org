...
export const useDeliveryProviderData = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Note: The supplier dashboard logic above should automatically find all delivered orders
      // where ALL material_items have receive_scanned = true, matching the supplier dashboard
