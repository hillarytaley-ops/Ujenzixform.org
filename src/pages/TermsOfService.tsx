      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Please read these terms carefully before using MradiPro's construction marketplace platform.
          </p>
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none">
            <p>
              By accessing or using MradiPro ("the Platform"), you agree to be bound by these Terms of Service 
              and all applicable laws and regulations. If you do not agree with any of these terms, you are 
              prohibited from using or accessing this platform.
            </p>
            <p>
              MradiPro is a construction marketplace platform operated in Kenya, connecting builders, 
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none space-y-4">
            ...
            <p>
              MradiPro acts as a marketplace facilitator. We do not:
            </p>
            <ul className="list-disc pl-6 space-y-2">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none space-y-4">
            ...
            <p>
              MradiPro supports various payment methods including M-Pesa, Airtel Money, bank transfers, 
            ...
            <p>
              Refund policies are determined by individual suppliers. MradiPro provides dispute resolution 
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none">
            <p>
              The MradiPro platform, including its logo, design, text, graphics, and software, is protected 
            ...
            <p className="mt-4">
              Content uploaded by users remains their property, but by uploading, you grant MradiPro a 
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none">
            <p>
              To the maximum extent permitted by Kenyan law, MradiPro shall not be liable for any indirect, 
            ...
            <p className="mt-4">
              ...
              paid by you to MradiPro in the twelve (12) months preceding the claim.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-gray max-w-none">
            <p>
              MradiPro reserves the right to modify these terms at any time. Users will be notified of 
        ...
        <Card>
          ...
          <CardContent className="prose prose-gray max-w-none">
            ...
            <ul className="list-none pl-0 space-y-2 mt-4">
              <li><strong>Email:</strong> legal@mradipro.co.ke</li>
