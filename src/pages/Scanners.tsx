            ...
            <Card className="bg-white/95 backdrop-blur-sm border-2 border-white/50 shadow-2xl">
              <CardHeader className="bg-gradient-to-r from-blue-50 via-green-50 to-yellow-50 border-b border-gray-200">
                <CardTitle className="flex items-center gap-3 text-3xl font-bold text-gray-900">
                  ...
                  Scanner Instructions & Security
                </CardTitle>
                <CardDescription className="text-lg text-gray-700">
                  Professional QR scanning instructions for Kenya's construction industry
                </CardDescription>
              </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold mb-3 flex items-center gap-2">
                  ...
                  Dispatchable Materials - For Suppliers
                </h4>
                <div className="bg-blue-50 p-3 rounded-lg mb-3">
                  <p className="text-sm font-medium text-blue-800">
                    🏪 Used by: Suppliers at their stores/warehouses
                  </p>
                  <p className="text-xs text-blue-700">
                    During material preparation and dispatch to construction sites
                  </p>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Scan materials before sending from warehouse
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Verify quality and quantity before dispatch
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Track materials during transport
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h4 className="font-semibold mb-3 flex items-center gap-2">
                  ...
                  Receivable Materials - For UjenziPro Staff
                  {!isAdmin && (
                ...
                <div className="bg-green-50 p-3 rounded-lg mb-3">
                  <p className="text-sm font-medium text-green-800">
                    👷 Used by: UjenziPro staff on construction sites
                  </p>
                  <p className="text-xs text-green-700">
                    During material arrival and verification at project locations
                  </p>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Scan materials upon arrival at site
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Verify material authenticity and quality
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                    Update inventory and site records
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
