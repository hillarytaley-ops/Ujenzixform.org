                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-red-700 space-y-3 mb-4">
                        ...
                        <div className="bg-white/50 rounded-lg p-4 border border-red-200">
                          <h4 className="font-semibold text-red-800 mb-2">🛡️ What's Protected:</h4>
                          <ul className="text-sm space-y-1 ml-4">
                            <li>• Email addresses and phone numbers</li>
                            <li>• Business addresses and contact persons</li>
                            <li>• Supplier communication details</li>
                          </ul>
                        </div>
                        
                        <div className="bg-white/50 rounded-lg p-4 border border-orange-200">
                          <h4 className="font-semibold text-orange-800 mb-2">🔑 Access Requirements:</h4>
                          <ul className="text-sm space-y-1 ml-4">
                            <li>• <strong>Administrator privileges</strong> - Full unrestricted access</li>
                            <li>• <strong>Verified business relationships</strong> - Recent purchase orders (30 days)</li>
                            <li>• <strong>Legitimate business needs</strong> - Documented through platform transactions</li>
                          </ul>
                        </div>
                        ...
                        {!user ? (
                          <div className="bg-blue-50 border border-blue-300 rounded-lg p-4">
                            ...
                            <p className="text-sm text-blue-700 mb-3">
                              Please sign in to verify your access permissions for the ultra-secure suppliers directory.
                            </p>
                            <Button 
                          ...
                          <div className="bg-amber-50 border border-amber-300 rounded-lg p-4">
                            ...
                            <p className="text-sm text-amber-700 mb-3">
                              Your current account (<strong>{userRole || 'User'}: {user?.email}</strong>) does not have 
                              the required permissions to access supplier contact information. This restriction protects 
                              suppliers from spam and data harvesting.
                            </p>
                            <div className="flex flex-wrap gap-2">
                              <Badge variant="outline" className="text-xs bg-amber-100 text-amber-800">
                                Current Role: {userRole || 'Standard User'}
                              </Badge>
                          ...
                          <div className="bg-green-50 border border-green-300 rounded-lg p-4">
                            ...
                            <p className="text-sm text-green-700 mb-2">
                              Welcome <strong>{user?.email}</strong>! You have full administrative access to the 
                              suppliers directory including all contact information and business details.
                            </p>
