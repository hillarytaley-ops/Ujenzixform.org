...
| [**Monitoring streaming — your implementation steps**](./MONITORING_STREAMING_IMPLEMENTATION_STEPS.md) | **Action checklist:** RTSP→HLS, HTTPS/CORS, relay, PTZ gateway, custom CV (order of operations) |
