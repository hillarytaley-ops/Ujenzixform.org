-- ============================================================
-- FORCE REFRESH: Re-apply the fix and verify it's working
-- ============================================================

-- Step 1: Drop and recreate the function to ensure it's updated
DROP FUNCTION IF EXISTS public.get_deliveries_for_provider_unified();

-- Step 2: Create the function with the fix
